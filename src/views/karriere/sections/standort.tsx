 ...
 * fields as plain props rather than the whole `content` object, so it knows
 * nothing about the section it happens to sit in — which is why it now sits in
 * `src/components/kanzlei/` rather than next to this file: the Kontakt page of
 * the main site shows the same map, and a component two pages share is no longer
 * a section of either of them.
 */
...
import type { LocationContent } from "@/data/mocks/karriere";
import {
  ELEMENT_MOTION,
  EYEBROW_MOTION,
  HEADING_MOTION,
